...
\noindent{\it Contributors: Raphael Gavazzi, Massimo Meneghetti, Jean-Paul Kneib, R Cabanac}
...
% ----------------------------------------------------------------------
% The present section Cosmology should be structured the same way the
% astrophysics section is, instead of being 
%
%
